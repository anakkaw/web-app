                            ...
                            {!selectedAgencyId ? (
                                <>
                                    ...
                                    <div className="space-y-3 max-h-[300px] overflow-y-auto pr-2">
                                        {agencies.filter(a => a.isPublished !== false).map(agency => (
                                            <div
                                                key={agency.id}
                                        ...
                                        {agencies.filter(a => a.isPublished !== false).length === 0 && (
                                            <div className="text-center py-12 border-2 border-dashed border-stone-200 rounded-xl">
                                                ...
                                                <p className="font-bold text-stone-500">ไม่มีหน่วยงานที่เปิดให้เข้าชม</p>
                                                <p className="text-sm text-stone-400 mt-1">กรุณาติดต่อผู้ดูแลระบบ</p>
                                            </div>
                                        )}
                                    </div>
                                </>
